...
const SignupPage = () => {
    ...
    const onSubmit = formData => console.log(JSON.stringify(formData, null, 2));
            ...
            <form className='authentication_form signup_form' onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='image_input_section'>
                    <div className='image_preview'>
                        <img src={profilePic ? URL.createObjectURL(profilePic) : user} id='file-ip-1-preview' alt="Profile" />
                    </div>
